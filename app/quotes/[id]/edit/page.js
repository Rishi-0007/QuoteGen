...
export default async function EditQuote({ params }){
  ...
  // transform for form defaults (string dates)
  ...
  q.travelStart = q.travelStart ? new Date(q.travelStart).toISOString().slice(0,10) : "";
  q.travelEnd = q.travelEnd ? new Date(q.travelEnd).toISOString().slice(0,10) : "";
